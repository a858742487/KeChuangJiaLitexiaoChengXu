...
var DOMAIN = "highnewtech.com/wordpress";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="科创家Lite"; //网站名称
var ABOUTID = 1; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
...
var PAYTEMPPLATEID = 'YkxYiF4YnxLreujm99sBK0FkYSo5NCINCw-wYJfMp3A';//赞赏消息模版id
var REPLAYTEMPPLATEID = 'YkxYiF4YnxLreujm99sBK0FkYSo5NCINCw-wYJfMp3A';//回复评论消息模版id
var ZANIMAGEURL = '';//微信赞赏的图片链接，用于个人小程序的赞赏
var LOGO = "../../images/logo-icon.jpg"; // 网站的logo图片
...
var DOWNLOADFILEDOMAIN = [
  { id: 1, domain: 'www.highnewtech.com' },
  { id: 2, domain: 'highnewtech.com' }
]
 //首页图标导航
...
var INDEXNAV = [
  { id: '1', name: '最热', image: '../../images/ranking.png', url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData: '' },
  { id: '2', name: '最新', image: '../../images/shop.png', url: '../comments/comments', redirecttype: 'apppage', appid: '', extraData:'' },
    { id: '3', name: '科创家', image: '../../images/app.png', url: '../page/page?categoryID=98', redirecttype: 'apppage', appid: '', extraData: '' },
   ]
